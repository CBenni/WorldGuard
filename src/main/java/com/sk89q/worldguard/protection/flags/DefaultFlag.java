...
public final class DefaultFlag {
    ...
    public static final StringFlag GREET_COMMAND = new StringFlag("greetcmd", RegionGroup.ALL);
    public static final StringFlag FAREWELL_COMMAND = new StringFlag("farewellcmd", RegionGroup.ALL);
    ...
    public static final Flag<?>[] flagsList = new Flag<?>[] {
        ...
        GREET_MESSAGE, FAREWELL_MESSAGE, GREET_COMMAND, FAREWELL_COMMAND, NOTIFY_ENTER, NOTIFY_LEAVE,
